...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('quickpages_quickpage', 'slug', self.gf('django.db.models.fields.CharField')(unique=True, max_length=1024))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'QuickPage.slug'
        db.alter_column('quickpages_quickpage', 'slug', self.gf('django.db.models.fields.CharField')(max_length=1023, unique=True))
