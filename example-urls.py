...
urlpatterns = patterns ('quickpages.views',
    (r'^$', 'quickpage', dict (name=None)),  # name=None means use the page named 'index'
)

# Another way to do the same thing:

urlpatterns = patterns ('quickpages.views',
    (r'^$', 'quickpage', dict (name='index')),
)
...
urlpatterns += patterns ('quickpages.views',
    (r'^(?P<name>.*)/$', 'quickpage', dict (template='products/product_detail.html'))
)
...
urlpatterns += patterns ('quickpages.views',
    (r'^(?P<name>.*)/$', 'quickpage', dict (template='products/product_detail.html', prods=Product.objects.all()))
)
